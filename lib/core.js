...
class Core {
     ...
     * @returns {Promise<{id: String, name: String, created: Date, nodes: Array<{id: String, values: Array<{name: String, type: String, value: any}>}>, classes: Array<{name: String, properties: Array<{name: String, type: String}>}>, relations: Array<{from: {id: String}, to: {id: String}, name: String}> }>}
     */
    async getGraph(graphId, extended = false) {
        try {
            ...
            graphDescription = { ...graphDbResponse.records[0].get("description"), nodes: [], classes: [], relations: [] };
            ...
            if (extended) { // TODO:
                ...
                let relationsDescriptions = await this.getRelations(graphId);
                if (relationsDescriptions !== null)
                    graphDescription.relations = relationsDescriptions;
            }
     ...
     * @param {String} graphId Graph id
     * @param {bool} extended Return extended graph information: nodes, classes and relationships
     * @returns {Promise<Array<{id: String, name: String, created: Date, nodes: Array<{id: String, values: Array<{name: String, type: String, value: any}>}>, classes: Array<{name: String, properties: Array<{name: String, type: String}>}>, relations: Array<{from: {id: String}, to: {id: String}, name: String}> }>>}
     */
     ...
     */
     async getRelations(graphId, relation = undefined) {
        try {
            ...
            if (relationsDbResponse.records.length === 0)
                return null;
